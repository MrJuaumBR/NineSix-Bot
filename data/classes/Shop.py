...
User_Items = [
    Product(name='Varinha de pesca(Madeira)', price=100, description='Habilita a pesca, 3 usos.', action=give_item),
    Product(name='Varinha de pesca(Cobre)', price=500, description='Habilita a pesca, 15 usos.', action=give_item),
    Product(name='Varinha de pesca(Prata)', price=2500, description='Habilita a pesca, 45 usos.', action=give_item),
    Product(name='Varinha de pesca(Ouro)', price=10000, description='Habilita a pesca, 200 usos.', action=give_item),
    Product(name='Varinha de pesca(Diamante)', price=50000, description='Habilita a pesca, 500 usos.', action=give_item),
    Product(name='Varinha de pesca(Obsidiana)', price=1000000, description='Habilita a pesca, Inquebrável.', action=give_item),
    Product(name='Picareta(Madeira)', price=100, description='Habilita a mineração, 3 usos.', action=give_item),
    Product(name='Picareta(Cobre)', price=500, description='Habilita a mineração, 15 usos.', action=give_item),
    Product(name='Picareta(Prata)', price=2500, description='Habilita a mineração, 45 usos.', action=give_item),
    Product(name='Picareta(Ouro)', price=10000, description='Habilita a mineração, 200 usos.', action=give_item),
    Product(name='Picareta(Diamante)', price=50000, description='Habilita a mineração, 500 usos.', action=give_item),
    Product(name='Picareta(Obsidiana)', price=1000000, description='Habilita a mineração, Inquebrável.', action=give_item),
    Product(name='Machado(Madeira)', price=100, description='Habilita o corte de madeira, 3 usos.', action=give_item),
    Product(name='Machado(Cobre)', price=500, description='Habilita o corte de madeira, 15 usos.', action=give_item),
    Product(name='Machado(Prata)', price=2500, description='Habilita o corte de madeira, 45 usos.', action=give_item),
    Product(name='Machado(Ouro)', price=10000, description='Habilita o corte de madeira, 200 usos.', action=give_item),
    Product(name='Machado(Diamante)', price=50000, description='Habilita o corte de madeira, 500 usos.', action=give_item),
